...
def modify_list(my_list, value_to_append=None, value_to_insert=None, value_to_remove=None):
    ...
    if value_to_append is not None:
     my_list.append(value_to_append)#write your code here to insert the element in the beginning of the list
    
    if value_to_insert is not None:
     my_list.insert(0, value_to_insert) #Write your code here to insert the element in the beginning of the list
            
    if value_to_remove is not None:
     if value_to_remove in my_list:
        my_list.remove(value_to_remove) ##Write your code here to insert the element in the beginning of the list
